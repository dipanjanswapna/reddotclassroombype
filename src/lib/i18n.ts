...
export const t = {
  ...
  or_demo: { en: 'Or use a demo account', bn: 'অথবা একটি ডেমো অ্যাকাউন্ট ব্যবহার করুন' },
  ...
  teacher_signup_desc: { en: 'Join our team of expert instructors. Fill out the form below to get started.', bn: 'আমাদের বিশেষজ্ঞ প্রশিক্ষকদের দলে যোগ দিন। শুরু করতে নিচের ফর্মটি পূরণ করুন।' },
