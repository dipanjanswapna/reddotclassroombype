    ...
    return (
        <section className="px-1 py-0 overflow-hidden">
            <motion.div 
                ...
                viewport={{ once: true }}
                className="relative bg-gradient-to-br from-blue-700 via-indigo-800 to-primary rounded-[20px] p-8 md:p-14 overflow-hidden shadow-2xl border border-white/10 group"
            >
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
                    <div className="space-y-6 text-center md:text-left">
                        ...
                        <p className="text-white/80 font-medium text-sm md:text-lg max-w-md mx-auto md:mx-0 leading-relaxed font-bengali">
