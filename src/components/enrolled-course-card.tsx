  ...
  return (
    ...
    >
      <Card className={cn(
        ...
        <div className="flex-1 flex flex-col pt-5 pb-2 space-y-4 text-left">
          <div className="space-y-1">
              ...
              {provider ? (
                  <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest truncate">By {provider.name}</p>
              ) : (
