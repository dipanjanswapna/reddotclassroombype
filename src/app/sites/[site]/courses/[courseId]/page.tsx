...
/**
 * @fileOverview Overhauled Partner Course Detail Page.
 * Synchronized with Main Detail view for elite responsiveness and professional aesthetics.
 */
              ...
              <div className="flex flex-wrap items-center gap-3">
                {isPrebookingActive && (
                    <Badge variant="warning" className="px-4 py-1.5 font-black uppercase tracking-wider animate-pulse rounded-full border-none shadow-lg">
                        Pre-booking Offering {format(new Date(course.prebookingEndDate!), 'MMM d')}
                    </Badge>
                )}
               ...
               <div className="flex flex-wrap items-center gap-x-8 gap-y-6 pt-4">
                    ...
                    <div className="flex flex-wrap items-center gap-8 border-l border-primary/10 pl-8">
                        {course.showStudentCount && (
                            <div className="flex flex-col">
                                <span className="text-[10px] text-muted-foreground uppercase font-black tracking-[0.2em]">Growth</span>
                        ...
                        <div className="flex flex-col">
                            <span className="text-[10px] text-muted-foreground uppercase font-black tracking-[0.2em]">Excellence</span>
                            <div className="flex items-center gap-1.5 text-base font-black">
                ...
                <CardHeader className="bg-primary/5 p-8 md:p-10">
                  {isPrebookingActive ? (
                      <div className="space-y-2">
                          <p className="text-muted-foreground line-through text-[10px] font-black uppercase tracking-widest opacity-60">Regular Listing: {course.price}</p>
