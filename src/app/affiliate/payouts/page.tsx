...
const payoutHistory = [
  { id: 'payout-aff-001', date: '2024-06-05', amount: 'BDT 8,500', status: 'Paid', method: 'Bank Transfer' },
  { id: 'payout-aff-002', date: '2024-05-05', amount: 'BDT 7,250', status: 'Paid', method: 'Bank Transfer' },
  { id: 'payout-aff-003', date: '2024-04-05', amount: 'BDT 9,120', status: 'Paid', method: 'Bank Transfer' },
];
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">BDT 12,500</p>
            <p className="text-sm text-muted-foreground">Next payout on Aug 5, 2024</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
            ...
            <CardDescription>A record of all payouts from RDC to you.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
