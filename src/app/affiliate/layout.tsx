            ...
            >
              {getIsActive(item.href) && (
                <motion.div 
                  ...
                  className="absolute inset-x-1 inset-y-2 md:inset-y-3 bg-cyan-600/10 rounded-xl -z-10"
              ...
              <item.icon className={cn("w-5 h-5 md:w-6 md:h-6", getIsActive(item.href) ? "text-cyan-600" : item.color)} />
