 ...
 * and matches the responsive flex distribution.
 */
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-8 space-y-12">
      ...
      <div className="flex flex-wrap justify-center sm:justify-start gap-8">
        {[...Array(8)].map((_, i) => (
          <div key={i} className="h-[480px] min-w-[280px] flex-1 max-w-[400px] border rounded-xl overflow-hidden flex flex-col bg-card/30">
