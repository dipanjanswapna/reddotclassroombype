            ...
            >
              {getIsActive(item.href) && (
                <motion.div 
                  ...
                  className="absolute inset-x-1 inset-y-2 bg-white dark:bg-orange-600 shadow-[0_4px_15px_rgba(0,0,0,0.1)] rounded-2xl -z-10"
              ...
              <span className={cn(
                ...
                getIsActive(item.href) ? "text-orange-600" : "text-muted-foreground"
              )}>{item.label}</span>
            </Link>
          ))}
        </div>
