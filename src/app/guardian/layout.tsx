            ...
            >
              {getIsActive(item.href) && (
                <motion.div 
                  ...
                  className="absolute inset-x-1 inset-y-1.5 bg-purple-600/10 rounded-lg -z-10"
              ...
              <item.icon className={cn("w-4 h-4", getIsActive(item.href) ? "text-purple-600" : item.color)} />
