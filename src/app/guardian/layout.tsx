            ...
            >
              {getIsActive(item.href) && (
                <motion.div 
                  ...
                  className="absolute inset-x-1 inset-y-2 bg-purple-600/10 rounded-xl -z-10"
              ...
              <item.icon className={cn("w-5 h-5", getIsActive(item.href) ? "text-purple-600" : item.color)} />
