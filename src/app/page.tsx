...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-background">
      ...
      <section className="py-16 lg:py-20 bg-secondary/30" aria-labelledby="social-media-heading">
        <div className="container mx-auto px-4 text-center">
      ...
      {/* Notes Banner */}
      <section className="bg-secondary/50 py-12" aria-labelledby="notes-banner-heading">
        <div className="container mx-auto px-4">
