...
import { Upload, Linkedin, Facebook, Twitter, Loader2, ExternalLink, PlusCircle, X } from "lucide-react";
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            {youtubeClasses.map(yc => {
                                const videoId = getYoutubeVideoId(yc.youtubeUrl);
                                const thumbnailUrl = videoId ? `https://img.youtube.com/vi/${videoId}/hqdefault.jpg` : 'https://placehold.co/120x90.png?text=Invalid+URL';
                                
                                return (
                                    <div key={yc.id} className="flex items-start gap-4 p-4 border rounded-md">
                                        <Image src={thumbnailUrl} alt={yc.title || "YouTube thumbnail"} width={120} height={90} className="rounded-md object-cover bg-muted" />
                    ...
                    {instructor?.slug && (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Click the link below to see how your profile looks to students.</CardDescription>
                            </CardHeader>
                            <CardContent>
