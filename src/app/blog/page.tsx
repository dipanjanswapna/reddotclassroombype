      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post, index) => (
            <Card key={post.slug} className="group flex flex-col glassmorphism-card border-white/20 bg-white/40 dark:bg-card/40 overflow-hidden rounded-2xl shadow-xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
