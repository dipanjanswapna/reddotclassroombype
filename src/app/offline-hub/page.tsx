...
export default async function OfflineHubPage() {
  ...
  return (
    <div className="bg-background min-h-screen text-foreground pb-20">
      {/* Dynamic Hero Carousel - Cleaned up wrapper */}
      ...
      {/* Static Hero Section - Polished for all devices */}
          ...
          <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                  <div className="space-y-8 text-center lg:text-left">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary font-bold text-sm tracking-widest uppercase mb-4 animate-in fade-in slide-in-from-left duration-700">
      ...
      {/* Offline Programs Grid - Standard 4-column layout */}
      {offlineCourses.length > 0 && (
        <section className="container mx-auto px-4 py-16 md:py-24">
          <div className="text-center mb-16 space-y-4">
            <h2 className="font-headline text-3xl md:text-5xl font-black tracking-tight text-green-700 dark:text-green-500">
              {offlineHubData.programsTitle?.[language] || "Our Programs"}
            </h2>
            <div className="h-1.5 w-24 bg-primary mx-auto rounded-full shadow-lg" />
            <p className="text-muted-foreground max-w-2xl mx-auto">Selected academic batches designed for the best results through face-to-face learning.</p>
          </div>
      ...
      <section className="bg-muted/30 py-16 md:py-24 border-y">
        <div className="container mx-auto px-4">
            <div className="text-center mb-16 space-y-4">
                ...
                <div className="h-1.5 w-24 bg-primary mx-auto rounded-full shadow-lg" />
                <p className="text-muted-foreground max-w-2xl mx-auto">Find an RDC center near you and join our community of learners.</p>
            </div>
                ...
                {allBranches.map((center) => (
                    <Card key={center.id} className="bg-card border-primary/10 hover:border-primary/40 transition-all duration-500 group shadow-xl rounded-3xl overflow-hidden">
                        ...
                        <CardContent className="px-6 pb-8 space-y-4">
                            ...
                            <Button asChild variant="outline" className="w-full mt-4 border-primary/20 hover:bg-primary hover:text-white rounded-xl font-bold transition-all">
      ...
      {offlineHubData.contactSection?.display && (
        <section className="container mx-auto px-4 py-16 md:py-24">
            <div className="bg-gradient-to-br from-primary via-red-700 to-black rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden shadow-2xl border border-white/10 group">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-4">
                        <Button asChild size="lg" className="bg-white hover:bg-red-50 text-primary font-black text-lg h-16 px-12 rounded-2xl shadow-2xl w-full sm:w-auto transition-all active:scale-95">
