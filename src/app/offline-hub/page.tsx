...
export default async function OfflineHubPage() {
  ...
  return (
    <div className="bg-background min-h-screen text-foreground overflow-x-hidden max-w-full">
      {/* Hero Carousel */}
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden border-b border-primary/5 py-10 md:py-14">
          ...
          <div className="container mx-auto px-4 relative z-10 max-w-full">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6 text-center lg:text-left">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary font-black text-[10px] tracking-widest uppercase mb-2 shadow-sm">
                          <Globe className="w-4 h-4" />
                          Bridging the Gap: Online to Offline
                      </div>
                      <h1 className="font-headline text-3xl md:text-5xl font-black tracking-tight leading-tight uppercase">
                          RDC <span className="text-primary">Offline Hub</span>
                      </h1>
                      <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                          <Button size="lg" className="bg-primary hover:bg-primary/90 text-white font-black px-10 h-14 rounded-2xl shadow-xl transition-all active:scale-95">
                              Book a Free Class
                          </Button>
      ...
      {offlineCourses.length > 0 && (
        <section className="container mx-auto px-4 py-10 md:py-14 max-w-full overflow-hidden">
          <div className="text-center mb-10 space-y-2">
            <h2 className="font-headline text-3xl md:text-4xl font-black tracking-tight text-green-700 dark:text-green-500 uppercase">
              {offlineHubData.programsTitle?.[language] || "Our Programs"}
            </h2>
            <div className="h-1.5 w-24 bg-primary mx-auto rounded-full shadow-md" />
            <p className="text-muted-foreground max-w-2xl mx-auto pt-4 text-sm md:text-base font-medium">Selected academic batches designed for the best results through face-to-face learning.</p>
          </div>
      ...
      {/* Offline Hubs/Centers */}
      <section className="bg-muted/30 py-10 md:py-14 border-y border-primary/5">
        <div className="container mx-auto px-4 max-w-full overflow-hidden">
            <div className="text-center mb-10 space-y-2">
                ...
                <div className="h-1.5 w-24 bg-primary mx-auto rounded-full shadow-md" />
                <p className="text-muted-foreground max-w-2xl mx-auto pt-4 text-sm md:text-base font-medium">Find an RDC center near you and join our community of learners.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {allBranches.map((center) => (
                    <Card key={center.id} className="bg-card border-primary/10 hover:border-primary/40 transition-all duration-500 group shadow-xl rounded-[2rem] overflow-hidden">
                        <div className="h-48 bg-muted relative overflow-hidden">
                            ...
                            <div className="absolute bottom-4 left-6">
                                <Badge className="bg-primary hover:bg-primary font-black uppercase text-[10px] tracking-widest border-none text-white px-4 py-1 shadow-lg">{center.branchCode || 'ACTIVE'}</Badge>
                            </div>
                        </div>
                        <CardHeader className="px-6 pt-6">
                            <CardTitle className="text-xl md:text-2xl font-black flex items-center gap-3 group-hover:text-primary transition-colors leading-tight">
                        ...
                        <CardContent className="px-6 pb-8 space-y-4">
                            ...
                            <Button asChild variant="outline" className="w-full mt-4 border-primary/20 hover:bg-primary hover:text-white rounded-xl font-black uppercase text-[10px] tracking-widest h-12 transition-all shadow-sm">
      ...
      {offlineHubData.contactSection?.display && (
        <section className="container mx-auto px-4 py-10 md:py-14 pb-24 max-w-full">
            <div className="bg-gradient-to-br from-primary via-red-700 to-black rounded-[3rem] p-8 md:p-16 text-center relative overflow-hidden shadow-2xl border border-white/10 group">
                ...
                <div className="relative z-10 space-y-8">
                    <div className="inline-flex p-5 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-xl group-hover:scale-110 transition-transform">
                        <MessageSquare className="w-10 h-10 text-white" />
                    </div>
                    <div className="space-y-4">
                        <h2 className="font-headline text-3xl md:text-5xl font-black text-white leading-tight uppercase tracking-tight">
                            {offlineHubData.contactSection.title[language] || "Ready to Join?"}
                        </h2>
                        <p className="text-lg md:text-2xl text-red-100 max-w-3xl mx-auto leading-relaxed font-medium opacity-90">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-4">
                        <Button asChild size="lg" className="bg-white hover:bg-red-50 text-primary font-black text-base md:text-lg h-16 px-10 rounded-2xl shadow-2xl w-full sm:w-auto transition-all active:scale-95 border-none">
                        ...
                        <Button asChild variant="outline" size="lg" className="bg-transparent border-white/30 hover:bg-white/10 text-white font-black text-base md:text-lg h-16 px-10 rounded-2xl w-full sm:w-auto transition-all border-2">
