    ...
    <footer className="bg-[#1a0505] text-gray-300 font-sans">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
             <div className="w-48 h-48 bg-white/10 p-4 rounded-md flex items-center justify-center mb-4 border-2 border-red-500">
                 <Image src={logoSrc} alt="RED DOT CLASSROOM Logo" width={160} height={160} className="h-40 w-auto filter brightness-0 invert" />
             </div>
      ...
      <div className="border-t border-red-500/10">
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm relative">
          ...
          <Button size="icon" className="bg-teal-500 hover:bg-teal-600 rounded-md absolute -top-5 right-4 shadow-lg" onClick={scrollToTop} aria-label="Scroll to top">
