        ...
        <section className="py-12 border-b border-white/5">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="p-8 rounded-3xl bg-card border border-white/10 shadow-xl space-y-4 group hover:border-primary/30 transition-all">
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {aboutSection.teamMembers?.map(member => {
                        ...
                        return (
                            <div key={member.id} className="relative group aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-white/5 bg-black">
                                <Image
                                    src={member.imageUrl}
                                    alt={member.name}
                                    fill
