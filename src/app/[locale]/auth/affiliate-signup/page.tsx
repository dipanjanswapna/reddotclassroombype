...
export default function AffiliateSignupPage() {
          ...
          <div className="flex items-center justify-center py-12 px-4 bg-background min-h-screen mesh-gradient">
              <Card className="w-full max-w-lg shadow-2xl rounded-[25px] border-primary/10 overflow-hidden">
                  <CardHeader className="text-center bg-primary/5 p-8 border-b border-primary/10">
                      <CardTitle className="text-2xl font-headline uppercase tracking-tight">Affiliate Registration Closed</CardTitle>
                  </CardHeader>
                  <CardContent className="p-10">
                      <p className="text-center text-muted-foreground font-medium">We are not accepting new affiliate applications at this time. Please check back later.</p>
  ...
  return (
    <div className="flex items-center justify-center py-12 px-4 bg-background min-h-screen mesh-gradient">
      <Card className="w-full max-w-lg shadow-2xl rounded-[25px] border-primary/10 overflow-hidden">
        <CardHeader className="text-center bg-primary/5 p-8 border-b border-primary/10">
          <CardTitle className="text-2xl font-headline uppercase tracking-tight">{t.become_an_affiliate[language]}</CardTitle>
          <CardDescription className="text-xs font-bold uppercase tracking-widest mt-1 opacity-60">{t.affiliate_signup_desc[language]}</CardDescription>
        </CardHeader>
