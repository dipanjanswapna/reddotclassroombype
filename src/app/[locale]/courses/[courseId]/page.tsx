...
/**
 * @fileOverview Ultimate Dynamic & Responsive Course Detail Page
 * Standardized sections: Overview, Instructors, Cycles, Syllabus, FAQ, Payment, Popular Courses.
 * Optimized for mobile (px-1) and high-density view.
 */
export default async function CourseDetailPage({
  ...
  return (
    <div className={cn("bg-background min-h-screen px-1", isBn && "font-bengali")}>
      {/* Breadcrumb System - Wall to Wall */}
      ...
      <section id="overview" className="relative pt-8 pb-10 border-b border-white/5 overflow-hidden scroll-mt-32">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <section className="py-0 px-0">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {course.whatYouWillLearn.map((item, index) => (
                                <div key={index} className="flex items-start gap-4 p-4 bg-muted/30 rounded-[20px] border border-white/5 hover:border-primary/20 transition-all">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
                            {course.instructors.map((inst) => (
                                <Link key={inst.slug} href={`/teachers/${inst.slug}`} className="group text-center">
                                    <div className="relative w-24 h-24 md:w-32 md:h-32 mx-auto mb-4 p-1 rounded-[2rem] border-2 border-primary/10 group-hover:border-primary transition-all duration-500 overflow-hidden">
                    ...
                    <section id="cycles" className="py-0 px-0 scroll-mt-32">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {course.cycles.sort((a,b) => a.order - b.order).map((cycle) => (
                                <Card key={cycle.id} className="rounded-[2rem] border-primary/10 overflow-hidden bg-card shadow-xl hover:border-primary transition-all group">
            ...
            {/* Sticky Pricing Sidebar - High Conversion */}
      ...
      <section className="py-12 md:py-16 px-0 border-t border-white/5">
          <div className="container mx-auto px-4">
