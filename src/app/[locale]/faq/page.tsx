    ...
    <div className="bg-background min-h-screen pb-20">
      ...
      <div className="container mx-auto px-4 mt-12">
              ...
              <Accordion type="single" collapsible className="w-full space-y-3">
                {section.items.map((item, itemIdx) => (
                  <AccordionItem 
                    ...
                    key={itemIdx}
                    className="border border-white/10 rounded-[20px] overflow-hidden bg-card/50 shadow-sm hover:border-primary/30 transition-all"
                  >
        ...
        <div className="max-w-4xl mx-auto mt-20">
          <div className="p-8 md:p-12 rounded-[30px] bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 text-center space-y-6 relative overflow-hidden">
